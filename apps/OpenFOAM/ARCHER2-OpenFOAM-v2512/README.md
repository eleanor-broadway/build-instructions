...
This is OpenFOAM release of December 2025 (v2512).
See, e.g., https://www.openfoam.com/news/main-news/openfoam-v2512
...
preferences `prefs.sh` to `OpenFOAM-v2512/etc`, and make a small number of
